...
# Showing that the expected number from each staker is the same
# Is this correct? 
# Need to think this through again ..........<<<<< START HERE TOMORROW!!!
expected_sync_mbrs_staker <- expected_sync_mbrs %>%
  group_by(staker) %>%
  summarise(expected_staker = sum(expected))     
