...
# =================================================
sync_committee_total_ETH_maxEB_now <- sum(sync_committee_df_maxeb_now$EB)
sync_committee_total_ETH_now <- 32 * 512
...
```
## Single validator dependence on active validator set 
```{r}
# Vary number of validators to see how it affects a single validator in the 
# active validator set, wrt selection to sync committees and next block proposer

# May code this as a Shiny app!
