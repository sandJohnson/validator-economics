...
# We now need to combine this with the randomly generated values & check if they pass the test
...
# Create the validator set consisting of an equal number of validators from each staker
...
sync_candidate <- sample(x=seq(0,7679),size = 1)      # draw a validator from the validator set
...
scenario_post_EIP7521_prob_A <- 1280/1560   # single stake (unconsolidated)
scenario_post_EIP7521_prob_B <- 20/1560     # maxEB stake
scenario_post_EIP7521_prob_C <- 20/1560    # varying consolidation 

# Post-EIP-7521 for four consolidated validator types
scenario_post_EIP7521_prob_single  <- 1420/1560  #  1 x 32 ETH
scenario_post_EIP7521_prob_single  <- 50/1560    #  2 x 32 ETH
scenario_post_EIP7521_prob_5_fold  <- 40/1560    #  5 x 32 ETH
scenario_post_EIP7521_prob_10_fold <- 20/1560    # 10 x 32 ETH
scenario_post_EIP7521_prob_maxEB   <- 30/1560    # 64 x 32 ETH
