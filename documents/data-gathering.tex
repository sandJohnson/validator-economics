...
\item Mike Neuder has also added a very useful \href{https://notes.ethereum.org/@mikeneuder/eip-7251-faq}{FAQ post for EIP7251}.
\item Christine Kim publishes regular summaries of the Ethereum All Core Developers calls. \href{https://www.galaxy.com/research/insights/ethereum-all-core-developers-consensus-call-111/}{Call 111} and \href{https://www.galaxy.com/research/insights/ethereum-all-core-developers-consensus-call-112/}{call 112} include the main discussion points for the proposal to increase the maximum effective balance for validators. A recording of the meetings are made available on YouTube. For call 111 the discussion around the increase in maximum effective balance starts around 59 mins (\href{https://youtu.be/ybgQuRcz9sg?t=3569}{recording}) and for call 112 the discussion around the increase in maximum effective balance starts around 46 mins (\href{https://youtu.be/zdqtl9x\_UjA?t=2775}{recording})
\end{itemize}

With this proposal validators can choose to auto-compound their stake, instead of having any rewards above the 32 ETH effective balance automatically withdrawn into their account. Therefore validators do not have to wait until 32 ETH has been accumulated before another 32 ETH deposit can be made, but they can stake whatever they earn which will also increase their rewards since they are based on the effective balance of the validator. This is attractive to smaller, typically solo, stakers who have to wait for a very long time to get enough ETH for another 32 ETH stake, but it is perhaps even more attractive to larger stakers who regularly earn far greater rewards. On the other hand consolidation and compounding of validators run a risk of increased slashing penalties.
...
Note that a security analysis has already been undertaken by the \gls{ef}, but further in-depth analysis is desirable.
...
\item Compounding stake with rewards earned
...
We contacted some people for estimates regarding the initial outlay and ongoing costs. The responses are noted below: \\
\noindent
...
I am hoping to talk to them too in the near future. 
...
% ---------------------------------------------------------------
\subsection{Compounding stake with rewards earned}
% ---------------------------------------------------------------
