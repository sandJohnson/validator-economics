...
\hline
\multirow{3}{*}{\rotatebox[origin=c]{90}{\parbox[c]{1cm}{\centering \textbf{Staker}}}} & \textbf{Before } & \multicolumn{5}{c|}{\textbf{After}} & \\
& \textbf{EIP-7251} & \multicolumn{5}{c|}{\textbf{EIP-7521}} & \textbf{Staker} \\
\cline{2-3} \cline{4-7} 
 & Single &  Single & 2-fold & 5-fold  &  10-fold  &   Maximum & \\
%\cline{2} \cline{3} \cline{4} \cline{5} \cline{6} \cline{7}
\hline
A & 170  & 170  & 0.016 & 0 & 0 & 0 &    \\ [2pt] \hline

B &  170  & 0  &0 &  & 0.013 & 0 & 0.013  \\ [2pt] \hline

C & 170  & 0.090 &0.016  & 0.006 & 1 & 0.167 &  \\ [2pt] \hline
\hline
%\multirow{2}*{ } &   & 0.940 & 0.016 & 0.156 & 0.019 & 1 &   &  \\
%& $(\frac{2840}{3120})$ & $(\frac{100}{3120})$ &  $(\frac{80}{3120})$ &   &  $(\frac{40}{3120})$ & $(\frac{60}{3120})$ &  \\  [2pt] \hline
