...
\hline
\multirow{5}{*}{\rotatebox[origin=c]{90}{\parbox[c]{1cm}{\centering \textbf{Staker}}}} & \multicolumn{2}{c|}{\textbf{Before }} & \multicolumn{13}{c|}{\textbf{After}} \\
& \multicolumn{2}{c|}{\textbf{EIP-7251}} & \multicolumn{13}{c|}{\textbf{EIP-7521}}  \\
\cline{2-3} \cline{4-16} 
 & \multicolumn{2}{c|}{Single} &  \multicolumn{2}{c|}{Single} & \multicolumn{2}{c|}{2-fold} & \multicolumn{2}{c|}{5-fold} &  \multicolumn{2}{c|}{10-fold} &  \multicolumn{2}{c|}{30-fold} &  \multicolumn{2}{c|}{Maximum}  &  Staker\\
%\cline{2-3} \cline{4-5} \cline{6-7} \cline{8-9} \cline{10-11} \cline{12-13}  \cline{14-15}
 ...
 & (select) &  (accept)  & (select) &  (accept)  & (select) &  (accept) & (select) &  (accept)  & (select) &  (accept) & (select) &  (accept)  & (select) &  (accept)  & (select)\\
\hline
A & $\frac{1}{3}$ & 1 & 0.755 &  0.016 & 0 & 0.031 & 0 & 0.078 & 0 & 0.156  & 0 & 0.469 & 0 & 1 &  0.755\\ [2pt] \hline

B & $\frac{1}{3}$ & 1 & $5.0 * 10^{-6}$  &0.016 & 0 & 0.031 & 0 & 0.078 & 0 & 0.156 & $2.5 * 10^{-6}$ & 0.469 & 0.012 & 1 & 0.012\\ [2pt] \hline

C & $\frac{1}{3}$ & 1 & 0.126 & 0.016 & 0.063 & 0.031 & 0.0265 & 0.078 & 0.013 & 0.156 & 0.004 & 0.469 & 0.002 & 1 & 0.233 \\  [2pt] \hline
\hline
% &   &   & 0.940 & 0.016 & 0.032 & 0.031 & 0.026 & 0.078 & 0.013 & 0.156 & 0.019 & 1 &   &  \\
%&   &   & $(\frac{2840}{3120})$ &  &  $(\frac{100}{3120})$ &  & $(\frac{80}{3120})$ &   &  $(\frac{40}{3120})$ &   &  $(\frac{60}{3120})$ &   &   &  \\  [2pt] \hline
