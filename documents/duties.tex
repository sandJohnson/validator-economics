...
\begin{table}[htp]
\caption{Simple sync committee example scenario }
\begin{center}
...
Assuming that ``After consolidation'' in Table \ref{tbl:syncscenario} represents the decisions made by each of the stakers regarding the validators they run after the implementation of EIP-7521. We will now consider the probabilities prior to and after EIP-7521 for each of these three stakers. Table \ref{tbl:syncprobs} summarises the various probabilities for sync committee membership.
...
\begin{tabular}{|l|c|c|c|c|c|c|r|}
\hline
& \multicolumn{2}{c|}{\textbf{Before }} & \multicolumn{5}{c|}{\textbf{After}} \\
& \multicolumn{2}{c|}{\textbf{EIP-7251}} & \multicolumn{5}{c|} {\textbf{EIP-7521}} \\
\cline{2-3} \cline{4-8} \\
